...
class MySubEdge(pyg.nn.MessagePassing):
    ...
    def train_step(self, particle_effect, node_feature, edge_index, edge_feature, y, check_conv=True):
        lr = self.lr
...
class MySubNode(nn.Module):
    ...
    def train_step(self, x, y, check_conv = True):
        lr = self.lr
...
#         state_dict = torch.load(checkpoint_path, map_location=map_loc)
...
#         node_out = self.layers[layer].train_step(x, y, lr=lr)
#         return node_out
...
#             if subnet.type == 'ee':
#                 if i in i_range:
#                     node_out, edge_feature = subnet.train_step(node_feature, node_feature, data.edge_index, edge_feature, data.y, check_conv)
#                 else:
#                     _, edge_feature = subnet(node_feature, node_feature, data.edge_index, edge_feature)
#             elif subnet.type == 'en':
#                 if i in i_range:
#                     node_out, node_feature = subnet.train_step(node_feature, data.y, check_conv)
#                 else:
#                     _, node_feature = subnet(node_feature)
#             elif subnet.type == 'pe':
#                 if i in i_range:
#                     node_out, edge_feature, input_to_node = subnet.train_step(node_feature, node_feature, data.edge_index,
...
#             elif subnet.type == 'pn':
#                 if i in i_range:
#                     node_out, node_feature = subnet.train_step(input_to_node, data.y, check_conv)
#                 else:
#                     _, node_feature = subnet(input_to_node)
#             elif subnet.type == 'dn':
#                 if i in i_range:
#                     node_out, _ = subnet.train_step(node_feature, data.y, check_conv)
#                 else:
