...
class Controller(object):
    ...
    def __init__(self):
        ...
        self.env = "real" #rospy.get_param("env/sim_or_real")
        self.bEnableEndRotation = True #rospy.get_param("controller/enable_end_rotation")
        self.b_left_arm = False #rospy.get_param("controller/enable_left_arm")
        ...
        self.project_dir = "C:/Users/91990/Documents/GitHub/FYP_Object_Detection_Model/shape_control_DLO_2" #rospy.get_param("project_dir")
        self.offline_model_name = "10_6" #rospy.get_param("controller/offline_model")
        self.control_law = "ours_rbf" #rospy.get_param("controller/control_law")
